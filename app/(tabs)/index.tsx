  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <View
            style={[styles.coinOuter, { borderColor }]}
            pointerEvents="none"
          />
        </Animated.View>
...
export default function HomeScreen() {
  ...
  useEffect(() => {
  console.log("🔁 Updated soundEnabled:", soundEnabled);
}, [soundEnabled]);
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      {settingsOpen ? (
        <SettingsScreen
          navigation={{ goBack: () => setSettingsOpen(false) }}
        ...
        <View style={[styles.container, theme === "dark" && styles.darkBg]}>
          ...
          <View style={styles.topBar}>
            <Pressable
              style={[styles.themeBtn, theme === "dark" && styles.themeBtnDark]}
              onPress={() => setTheme(theme === "light" ? "dark" : "light")}
            >
              <MaterialIcons
                name={theme === "dark" ? "wb-sunny" : "dark-mode"}
                size={28}
                color={theme === "dark" ? "#4DA8DA" : "#357"}
              />
            </Pressable>
            <Pressable
          ...
          {!showResult && (
            <View style={styles.sliderContainer}>
              <View
                style={[styles.slider, theme === "dark" && styles.sliderDark]}
              >
                <Animated.View
                  style={[
                    styles.sliderBtn,
                    {
                      top: sliderY,
                      backgroundColor: theme === "dark" ? "#fff" : "#357",
                      borderColor: theme === "dark" ? "#4DA8DA" : "#eaf2fa",
                    },
                  ]}
